...
```{r fig20, fig.cap='Predictions from binary response models (simulated data)', out.width='80%', fig.asp=.75, fig.align='center'}
plot(x,y)
...
```{r fig21, fig.cap='Logit effect plot', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r fig22, fig.cap='Marginal effects for logit model', out.width='80%', fig.asp=.75, fig.align='center'}
...
By construction, the parameter estiamtes are the same but the standard errors are larger for teh QMLE. 
...
In this example we are are interested in criminal prognosis of individuals released from prison. 
